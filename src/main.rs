...
fn main() {
    ...
    let material_mirror = material::Material::Metal(Metal::new(Vec3::new(0.8, 0.8, 0.8), 0.3));
    let material_dark_mirror = material::Material::Metal(Metal::new(Vec3::new(0.8, 0.6, 0.2), 1.0));
